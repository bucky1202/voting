    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <header class="flex flex-col md:flex-row items-center justify-between px-8 py-4">
            ...
            <div class="flex items-center mt-2 md:mt-0">
                ...
                @endif
                <a href="">
                    <img src="{{ asset('assets/img/gravatar.png') }}" alt="avatar" class="w-10 h-10 rounded-full">
                </a>
            </div>
        </header>
            ...
            <div class="w-70 mx-auto md:mx-0 md:mr-5">
                <div
                    ...
                    style="border-image-source:linear-gradient(to bottom,rgba(50,138,241,0.22),rgba(99,123,255,0));
                            ...
                            background-image:linear-gradient(to bottom,#ffffff,#ffffff),linear-gradient(to bottom,rgba(50,138,241,0.22),rgba(99,123,255,0));background-origin:border-box;
                    ...
                    @else
                        <div class="my-6 text-center">
                            ...
                            <a
                                href="{{ route('register') }}"
                                class="inline-block justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400transition duration-150 ease-in px-6 py-3 mt-4">
                                Sign Up
                            </a>
                        </div>
                    @endauth
